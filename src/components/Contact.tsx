...
const Contact = () => {
    ...
    return (
        <div className='w-full h-[100vh] md:px-20 py-2 px-1 flex flex-col'>
            <div className='relative h-full rounded-3xl w-full '>
                ...
                <div className='z-5 top-0 left-0 px-16 py-16 w-full h-full absolute text-white sm:py-20 max-[400px]:'>
                    <div className='z-5 xl:px-80 md:px-10 '>
                        <h1 className='text-2xl font-extrabold mb-2 sm:text-4xl max-[400px]:text-xl'>Let&lsquo;s talk</h1>
                        <h1 className='text-lg font-medium mb-2 sm:text-xl max-[400px]:text-sm'>Whether you’re looking to build a new website, improve your existing platform, or bring a unique project to life, I’m here to help.</h1>
                        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-y-4 mt-5'>
                            ...
                            <button type='submit' className='flex flex-row items-center justify-center gap-2 bg-white text-black py-2 text-2xl font-semibold px-4 rounded-lg xl:mt-5 max-[400px]:text-xl'>Send Message<Image src={ArrowUp} alt="Loading..." className="w-4 h-4" /></button>
                        </form>
                    </div>
                </div>
            </div>
